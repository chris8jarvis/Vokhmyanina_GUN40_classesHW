...
namespace ClassesHW
{
    internal class Program
    {
        ...
        private static void TestHowToBreakLoops()
        {
            // #1
            int targetSum = 100;
            int sum = 0;
            int age = 0;
            while (sum <= targetSum || age < 100)
            {
                age++;
                Console.Write("Enter coins count: ");
                string input = Console.ReadLine();
                int.TryParse(input, out int inputSum);
                sum += inputSum;
            }
            ...
            while(true)
            {
                ...
                Console.Write("Enter the Name or 'stop' for exit: ");
                string input = Console.ReadLine();
